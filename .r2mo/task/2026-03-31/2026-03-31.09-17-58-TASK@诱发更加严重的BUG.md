...
- 2026-03-31: [Orchestrator] Adjusted overview per latest requirement:
  ...
  - 表格继续保持撑满可用页面宽度
- 2026-03-31: [Orchestrator] Switched overview to native QWidget/QGridLayout rendering:
  - 不再依赖 QTextEdit/HTML 表格宽度
  - 保留原有 emoji、表头、字号、标题颜色、value 颜色语义
  - 仅改为原生两列表格承载，确保宽度随页面稳定铺满
